 ...
 * @param {CompiledMergePolicy} mergePolicy - A "compiled" mergePolicy object as output from `fluid.compileMergePolicy`
 ...
 * @param {Component} that - The component in progress
