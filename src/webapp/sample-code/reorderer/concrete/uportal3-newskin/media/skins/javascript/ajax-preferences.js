...
function toggleEditTabDialog(action) {
    ...
    if (action == "show") {
        ...
        tabNameDiv.parentNode.className = "uP-mainnav-li-edit tab-edit";
    } else {
        tabNameDiv.parentNode.className = "uP-mainnav-li-active editable-tab";
