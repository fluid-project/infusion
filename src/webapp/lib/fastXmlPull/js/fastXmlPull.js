/* 
=========================================================================
fastXmlPull.js, a fast XML Pull Parser for Fluid Infusion.
This code is based on tinyxmlsax.js - an XML SAX parser in JavaScript
version 3.1

Copyright (C) 2000 - 2002, 2003 Michael Houghton (mike@idle.org), Raymond Irving and David Joham (djoham@yahoo.com)
Modifications by the Fluid Project are Copyright 2010, University of Cambridge
