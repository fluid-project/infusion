...
function testFirstDroppableTargetSkipColumn() {
    ...
    var myHandler = new fluid.PortletLayoutHandler ({
    	container: {},     /* Stub the container for the test */
        portletLayout: smallLayout,
        dropTargetPermissions: smallDropTargetPerms
    });
    ...
    var actual = myHandler.firstDroppableTarget (portlet1id, nextColIndex, moveRight);
    ...
    actual = myHandler.firstDroppableTarget (portlet3id, nextColIndex, moveLeft);
...
function testFirstDroppableTarget() {
    ...
    var actual = portletHandler.firstDroppableTarget (portlet4id, nextColIndex, moveRight);
    ...
    actual = portletHandler.firstDroppableTarget (portlet1id, nextColIndex, moveRight);
    assertEquals ("Can't move portlet1 right at all", portlet1id, actual.id);
    actual = portletHandler.firstDroppableTarget (portlet2id, nextColIndex, moveRight);
    assertEquals ("Can't move portlet2 right at all", portlet2id, actual.id);
    
    // Can't move portlet5 left nor right (it's fixed).
    nextColIndex = 2;
    actual = portletHandler.firstDroppableTarget (portlet5id, nextColIndex, moveRight);
    assertEquals ("Can't move portlet5id right at all", portlet5id, actual.id);
    nextColIndex = 0;
    actual = portletHandler.firstDroppableTarget (portlet5id, nextColIndex, moveLeft);
    assertEquals ("Can't move portlet5id left at all", portlet5id, actual.id);
    
    // Can't move any portlet in first column left.
    var noSuchColumn = -1;
    actual = portletHandler.firstDroppableTarget (portlet1id, noSuchColumn, moveLeft);
    assertEquals ("Can't move portlet1 left at all", portlet1id, actual.id);
    
    actual = portletHandler.firstDroppableTarget (portlet2id, noSuchColumn, moveLeft);
    assertEquals ("Can't move portlet2 left at all", portlet2id, actual.id);
    
    actual = portletHandler.firstDroppableTarget (portlet3id, noSuchColumn, moveLeft);
    assertEquals ("Can't move portlet3 left at all", portlet3id, actual.id);
    
    actual = portletHandler.firstDroppableTarget (portlet4id, noSuchColumn, moveLeft);
    assertEquals ("Can't move portlet4 left at all", portlet4id, actual.id);

    // Can't move any portlet in last column right.
    noSuchColumn = 3;
    actual = portletHandler.firstDroppableTarget (portlet7id, noSuchColumn, moveRight);
    assertEquals ("Can't move portlet7id left at all", portlet7id, actual.id);
    
    actual = portletHandler.firstDroppableTarget (portlet8id, noSuchColumn, moveRight);
    assertEquals ("Can't move portlet8id left at all", portlet8id, actual.id);
    
    actual = portletHandler.firstDroppableTarget (portlet9id, noSuchColumn, moveRight);
    ...
    actual = portletHandler.firstDroppableTarget (portlet7id, nextColIndex, moveLeft);
    ...
    actual = portletHandler.firstDroppableTarget (portlet6id, nextColIndex, moveLeft);
    ...
    actual = portletHandler.firstDroppableTarget (portlet6id, nextColIndex, moveRight);
