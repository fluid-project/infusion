...
(function ($, fluid) {
    ...
    fluid.staticEnvironment.fullNoPreviewUIOptions = fluid.typeTag("fluid.fullNoPreviewUIOptions");
    fluid.demands("fluid.uiOptionsTemplateLoader", "fluid.fullNoPreviewUIOptions", {
        options: {
            templates: {
