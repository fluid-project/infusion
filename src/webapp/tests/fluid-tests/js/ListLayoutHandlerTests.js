...
$(document).ready (function () {
    ...
    listLHTests.test ("Movement", function () {
        ...
        jqUnit.assertUndefined(fluid.testUtils.orderChangedCallbackWasCalled);
        ...
        jqUnit.assertTrue("After, callback should have been called", fluid.testUtils.orderChangedCallbackWasCalled);
