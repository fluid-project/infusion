    ...
    $(document).ready(function () {
        ...
        tests.asyncTest("Full w/o Preview UIOptions Options Munging Integration tests", function () {
            ...
            setTimeout(function () {
                ...
                var actualTextFontStrings = that.uiOptionsLoader.uiOptions.textControls.options.strings.textFont;
                var actualTextFontControlValues = that.uiOptionsLoader.uiOptions.textControls.options.controlValues.textFont;
