...
(function ($) {
    ...
    fluid.tests.gpiiPanel.testDefault = function (that) {
        ...
        jqUnit.assertEquals("The export button text is expected", messageBase.exportDescr, that.locate("exportLabel").text());
        jqUnit.assertEquals("The import button text is expected", messageBase.importDescr, that.locate("importLabel").text());
