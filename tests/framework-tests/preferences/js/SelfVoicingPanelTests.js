...
(function ($) {
    ...
    fluid.tests.speakPanel.verifyRendering = function (that) {
        ...
        jqUnit.assertEquals("The text for speakLabel should be rendered", that.options.testMessages.speakLabel, that.locate("label").text());
        jqUnit.assertEquals("The text for speakChoiceLabel should be rendered", that.options.testMessages.speakChoiceLabel, that.locate("choiceLabel").text());
    };
